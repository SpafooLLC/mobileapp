...
namespace Netsam.Modules.NS_ClientRegistration.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Netsam.Modules.NS_ClientRegistration.Data.SqlDataprovider,NS_ClientRegistration";
