...
namespace Netsam.Modules.NS_Registration.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        public override System.Data.IDataReader GetFormUserResponse(string Username, int StepID, int QCategoryID)
        {
            return SqlHelper.ExecuteReader(ConnectionString, NamePrefix + "GetFormUserResponse", Username, QCategoryID, StepID);
        }
        ...
        public override void AddFormUser(string un, string pwd, string FirstName, string LastName, string Street, string Cit, string State, string Zip, string Phone, string Mobile, string Gender, string email)
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, NamePrefix + "AddFormUser", un, pwd, FirstName, LastName, Street, Cit, State, Zip, Phone, Mobile, Gender, email);
        }

        public override System.Data.IDataReader GetFormUser(string Username)
        {
            return SqlHelper.ExecuteReader(ConnectionString, NamePrefix + "GetFormUser", Username);
        }

        public override string RemoveFormUser(string Username)
        {
            try
            {
                SqlHelper.ExecuteNonQuery(ConnectionString, NamePrefix + "RemoveFormUser", Username);
                return "1";
            }
            catch (Exception ex)
            {
        ...
        public override System.Data.IDataReader ListFormUsers()
        {
            return SqlHelper.ExecuteReader(ConnectionString, NamePrefix + "ListFormUser");
        }
       
        public override int AddFormUserReponse(string Username, int QuestionID, int OptionID, string OptionText)
        {
            return int.Parse(SqlHelper.ExecuteScalar(ConnectionString, NamePrefix + "AddFormUserResponse", Username, QuestionID, OptionID, OptionText).ToString());
        }
        public override int IsFormUserValidated(string un, string pwd)
        {
            int iVal = int.Parse(SqlHelper.ExecuteScalar(ConnectionString, NamePrefix + "ValidateFormUser", un, pwd).ToString());

            return iVal;
        }

        public override void RemoveResponseByUser(string un)
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, NamePrefix + "RemoveResponseByUser", un );
        }
        #endregion

        #region User Hardware Methods
        public override void AddUserHardware(int UserID, string HardwareName, string DeviceToken, bool IsWebVersion)
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, NamePrefix + "AddUserHardware", UserID, HardwareName, DeviceToken, IsWebVersion);
        }
        public override void UpdateUserHardware(int UserID, string HardwareName, string DeviceToken, bool IsWebVersion)
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, NamePrefix + "UpdateUserHardware", UserID, HardwareName, DeviceToken, IsWebVersion);
        }
        public override System.Data.IDataReader ListUserHardware()
        {
            return SqlHelper.ExecuteReader(ConnectionString, NamePrefix + "ListUserHardware");
        }

        public override System.Data.IDataReader GetUserHardware(int UserID)
        {
            return SqlHelper.ExecuteReader(ConnectionString, NamePrefix + "GetUserHardware", UserID);
        }
        #endregion
    }
}