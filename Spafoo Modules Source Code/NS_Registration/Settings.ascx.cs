...
namespace Netsam.Modules.NS_Registration
{
    ...
    /// 
    /// Because the control inherits from NS_RegistrationSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : NS_RegistrationModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    ddlRoles.DataSource = oCtrl.GetRoles(this.PortalId);
                    ddlRoles.DataTextField = "RoleName";
                    ddlRoles.DataValueField = "RoleID";
                    ddlRoles.DataBind();
                    if (Settings["NSR_ApproverRole"] != null)
                    {
                        int _Index = int.Parse(Settings["NSR_ApproverRole"].ToString());
                        ddlRoles.ClearSelection();
                        ddlRoles.Items.FindByValue(_Index.ToString()).Selected = true;
                    }
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                //module settings
                modules.UpdateModuleSetting(ModuleId, "NSR_ApproverRole", ddlRoles.SelectedItem.Value);
