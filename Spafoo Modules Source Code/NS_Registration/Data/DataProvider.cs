...
namespace Netsam.Modules.NS_Registration.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public abstract IDataReader GetFormUserResponse(string Username, int StepID, int QCategoryID);
        ...
        public abstract void AddFormUser(string un, string pwd,string FirstName, string LastName,string Street,string Cit,string State,string Zip,string Phone,string Mobile,string Gender ,string email);
        public abstract int IsFormUserValidated(string un, string pwd);
        public abstract void RemoveResponseByUser(string un);
        public abstract int AddFormUserReponse(string Username, int QuestionID, int OptionID, string OptionText);

        public abstract string RemoveFormUser(string Username);
        public abstract IDataReader GetFormUser(string Username);

        public abstract IDataReader ListFormUsers();
        #endregion

        #region User Hardware Methods
            public abstract void AddUserHardware(int UserID,string HardwareName,string DeviceToken,bool IsWebVersion);
            public abstract IDataReader GetUserHardware(int UserID);
            public abstract IDataReader ListUserHardware();
            public abstract void UpdateUserHardware(int UserID, string HardwareName, string DeviceToken, bool IsWebVersion);
        #endregion
    }
}