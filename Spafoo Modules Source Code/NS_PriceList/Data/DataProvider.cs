...
namespace Netsam.Modules.NS_PriceList.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Netsam.Modules.NS_PriceList.Data.SqlDataprovider,NS_PriceList";
        ...
        public abstract IDataReader GetStatRPTByServices(string From, string To);
        public abstract IDataReader GetStatRPTByProvider(string From, string To);

        public abstract IDataReader GetStatRPTByProNSrvc(string From, string To);
