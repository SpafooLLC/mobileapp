...
function ShowAppointmentID(ID) {// Shows Appointment In-Depth information
    ...
    $("#newapp_" + ID).hide();
    // Update SeenStatus
    NSR_MSS_MakeRequest('/DesktopModules/NS_MakeAppointment/rh.asmx/UpdateAppSeenStatus', "{'AppID':'" + ID + "'}");
...
function SetSoonestAppointment(csv) {
    ...
    NSR_MSS_MakeRequest("/DesktopModules/NS_MakeAppointment/rh.asmx/IsProviderSlotFree",
...
function NS_ShowCompletedAppDetail(ID) {
    ...
    var _URL = "/DesktopModules/NS_MakeAppointment/rh.asmx/GetAppointment";
    var _data = "{'ID':'" + ID + "'}";
    NSR_MSS_MakeRequest(_URL, _data, NS_ShowCompletedAppDetail_SuCB);
}
