...
namespace Netsam.Modules.ManageScheduledServices.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Netsam.Modules.ManageScheduledServices.Data.SqlDataprovider,NS_ManageScheduledServices";
        ...
        public abstract void AddProviderAvailability(int ProID, DateTime Dated, string StartTime, string EndTime);
        public abstract void RemoveAvailability(int ID);
        public abstract void ClearAvailability(int ProID);
        public abstract IDataReader ListAvailability(int ProID);
        public abstract IDataReader MyAvailabilityOn(int ProID,DateTime OnDate);
        #endregion
