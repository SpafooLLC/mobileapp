...
namespace Netsam.Modules.ManageScheduledServices.Components
{
    ...
    public class ScheduledServiceController //: IPortable, ISearchable, IUpgradeable
    {
        ...
        public void ClearAvailability(int ProID)
        {
            DataProvider.Instance().ClearAvailability(ProID);
        }
        ...
        public List<ProAvailabilityInfo> MyAvailabilityOn(int ProviderID,DateTime OnDate)
        {
            return DotNetNuke.Common.Utilities.CBO.FillCollection<ProAvailabilityInfo>(DataProvider.Instance().MyAvailabilityOn(ProviderID, OnDate));
        }
    }
