...
function NS_AddAddress_SuCB(d) {
    ...
    var _data = '';
    if (!NS_MA_IsSoonest)
        _data = "{'ClientID':'" + NS_MA_ClientID + "','ProviderID':'" + NSD_MA_CurrentPro.split(":")[0] + "','AddressID':'" + d + "','ForDate':'" + oTimeSlot.TimeSlot[0].dated + "','AtTime':'" + oTimeSlot.TimeSlot[0].start + "','EndTime':'" + oTimeSlot.TimeSlot[0].end + "','CSVSRVC':'" + CSVService + "','PayTxnID':'" + oUserInput.PayTxnID + "','CCNumber':'" + oUserInput.CardNumber + "','Expriry':'" + oUserInput.Expiry + "','Comment':'" + _Comment + "','PayProfileID':'" + oUserInput.CPPID + "','EditAppID':'" + EditAppID + "'}";
    else {
        _data = "{'ClientID':'" + NS_MA_ClientID + "','ProviderID':'" + NSD_MA_CurrentPro.split(":")[0] + "','AddressID':'" + d + "','ForDate':'','AtTime':'','EndTime':'','CSVSRVC':'" + CSVService + "','PayTxnID':'" + oUserInput.PayTxnID + "','CCNumber':'" + oUserInput.CardNumber + "','Expriry':'" + oUserInput.Expiry + "','Comment':'" + _Comment + "','PayProfileID':'" + oUserInput.CPPID + + "','EditAppID':'" + EditAppID + "'}";
    }
