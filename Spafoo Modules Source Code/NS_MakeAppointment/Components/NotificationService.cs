namespace Netsam.Modules.MakeAppointment.Components
{
    ...
    public class NotificationService
    {
        ...
        public int SendAndroidNotification(string deviceToken, string Message)
        {
            if (!string.IsNullOrEmpty(deviceToken) && deviceToken.Length > 40)
            {
                try
                {
                    ...
                    var applicationID = "AIzaSyBzCmvzkzeLNgmUSdefqA_J_LmdwehmS34"; //System.Web.Configuration.WebConfigurationManager.AppSettings["AndroidAPIKey"].ToString(); ;
                    var SENDER_ID = "419078761457";//System.Web.Configuration.WebConfigurationManager.AppSettings["AndroidSenderId"].ToString(); ;
                    ...
                    using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                    {
                        ...
                        string postData = "{\"data\": { \"message\" : " + "\"" + Message + "\",\"time\": " + "\"" + System.DateTime.Now.ToString() + "\", \"title\" : " + "\"" + title + "\"},\"registration_ids\":[\"" + RegistrationId + "\"]}";
        ...
        public void SendToiOS(string DeviceID, string Message)
        {
            ...
            //String hostname = "gateway.sandbox.push.apple.com";//ConfigurationManager.AppSettings["AppleHostName"].ToString();
               String hostname = "gateway.push.apple.com";

            string certificatePath =   HostingEnvironment.MapPath("/Spafoo_PushNotification.p12");//"C:/webDataDNN/spafoo/certs/iphone/SpafooPushService.p12";//System.Web.HttpContext.Current.Server.MapPath("/certs/iphone/SpafooPushService.p12");
                                       // Server.MapPath("");System.Web.HttpContext.Current.Server.MapPath("/Spafoo_PushNotification.p12");
