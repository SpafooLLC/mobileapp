    ...
    public class Notif_Scheduler : SchedulerClient
    {
        ...
        public override void DoWork()
        {
            try
            {
                ...
                lstAppsIn24Hrs = oCtrl.GetOrdersWithIn(24);
                
                foreach (AppointmentInfo oApp in lstAppsIn24Hrs)
                {
                    oCtrl.AddNotification(oApp.ClientID, oApp.ProviderID, 5, 0, oApp.AppointmentID);
                }
                ...
                //Your code goes here
                //To log note
                this.ScheduleHistoryItem.AddLogNote(lstAppsIn24Hrs.Count.ToString()+ " Appointment(s) processed for 24 hrs Notification.<br/>" + lstAppsIn2Hrs.Count.ToString() + " Appointment(s) processed for 2hrs notification");
