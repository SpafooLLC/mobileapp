...
<div id="NS_dvDashboardOuter" style="width:100%;">
    <div class="bread">
        <div class="pback" onclick="NS_OnPreviousClick(); return false;"><i class="fa fa-angle-left fa-2x"></i></div>
        <div class="ptitle">
...
<%--<link rel="stylesheet" href="/DesktopModules/NS_Registration/bootstrap.css">--%>
