...
namespace Netsam.Modules.MakeAppointment.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public abstract int AddProviderAppointment(int ClientID, int ProviderID, int AddressID, string ForDate, string AtTime, string PayTxnID, string CCNumber, string Expriry,string Comment,string oAuthTxn,int EditAppID);
      ...
      //  public abstract void UpdateLocationAppointment(int AddressID, int AppointmentID);
        ...
        /// <returns></returns>
        public abstract int AddRating(int RatingByID, int RatingToID, decimal RatingValue, int RatingTypeID);
        public abstract int AddUserReview(int ByUserID, int ToUserID, string ILike, string IDLike, string Comments, int DisplayNameAs);
