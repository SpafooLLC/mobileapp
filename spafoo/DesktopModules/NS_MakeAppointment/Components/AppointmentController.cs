...
namespace Netsam.Modules.MakeAppointment.Components
{
    ...
    public class AppointmentController //: IPortable, ISearchable, IUpgradeable
    {
        ...
        public int AddAppointment(int ClientID, int ProviderID, int AddressID, string ForDate, string AtTime,string PayTxnID, string CCNumber, string Expriry,string Comment,string oAuthTxn,int EditAppID) {
            return SqlDataProvider.Instance().AddProviderAppointment(ClientID, ProviderID, AddressID, ForDate, AtTime, PayTxnID, CCNumber, Expriry, Comment, oAuthTxn,EditAppID);
        }
    ...
    {
        public int AddRating(int RatingByID, int RatingToID, decimal RatingValue, int RatingTypeID)
        {
            return DataProvider.Instance().AddRating(RatingByID, RatingToID, RatingValue, RatingTypeID);
        }
        ...
        public int AddUserReview(int ByUserID, int ToUserID, string ILike, string IDLike, string Comments, int DisplayNameAs)
        {
            return DataProvider.Instance().AddUserReview(ByUserID, ToUserID, ILike, IDLike, Comments, DisplayNameAs);
        }
    }
    ...
    public class AppointmentInfo
    {
        ...
        public NS_UserInfo ProviderInfo
        {
            ...
            {
                DotNetNuke.Entities.Users.UserController oCtrl = new DotNetNuke.Entities.Users.UserController();
                UserInfo tUser = oCtrl.GetUser(0, this.ProviderID);
                NS_UserInfo oUser = new NS_UserInfo();
                oUser.DisplayName = tUser.DisplayName;
                oUser.FirstName = tUser.FirstName;
                oUser.LastName = tUser.LastName;
