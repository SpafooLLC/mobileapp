...
<div id="dvActionPanel" style="display:none;position:absolute; cursor:pointer; z-index:10000">
  <img src="/portals/0/images/roleft.png" onclick="return NS_RotateLeft();"/><br />
  <img src="/portals/0/images/roright.png" onclick="return NS_RotateRight();"/><br />
    ...
    function readFile(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            basic = $('#'+elementID).croppie({
                ...
                url: 'https://lorempixel.com/500/400/'
            });
