...
namespace Netsam.Modules.NS_FindProvider
{
    ...
    /// 
    /// Because the control inherits from NS_FindProviderSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : NS_FindProviderModuleSettingsBase
    {
