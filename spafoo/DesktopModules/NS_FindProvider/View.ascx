...
<div class="fpbottom" style="display:none;padding-top:10px;">
    ...
    <div>
      <div class="col-xs-6 nopad"><a href="#" style="display:none" class="green-btn1 block1 mr1px1" onclick="NS_GotoASAP();">ASAP - I'm Ready Now!</a>&nbsp;</div>
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&libraries=places&key=AIzaSyAaMEqVj82GZtDuCqOrf6OwYnMYR_yE0HY"></script>
