...
namespace Netsam.Modules.NS_UserProfile
{
    ...
    /// 
    /// Because the control inherits from NS_UserProfileSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : NS_UserProfileModuleSettingsBase
    {
