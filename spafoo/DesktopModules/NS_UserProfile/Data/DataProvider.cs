...
namespace Netsam.Modules.NS_UserProfile.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Netsam.Modules.NS_UserProfile.Data.SqlDataprovider,NS_UserProfile";
        ...
        public abstract int AddWorkSample(int UserID, string FilePath);
        public abstract void UpdateWorkSample(int FileID, string FilePath);

        public abstract void RemoveWorkSample(int UserID, string FilePath);
        public abstract int GetUnseenCount(int UserID);

        public abstract string GetProTagLine(int UserID);

        public abstract void UpdateProTagLine(int UserID, string TagLine);
        #endregion
