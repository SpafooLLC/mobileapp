...
<div id="dvMyScheduleMain" class="NS_On">
    <div class="inbody">
        <a href="#" onclick="ShowMySchedule();return false;">
            <div class="gbox">
                <img src="/DesktopModules/NS_MakeAppointment/Images/Site/proapp.png">
                <h2>My Appointments</h2>
                <p>(Scheduled and Requested)</p>
            </div>
        </a>
        <a href="#" onclick="ShowMyAvailability();return false;">
            <div class="gbox">
                <img src="/DesktopModules/NS_MakeAppointment/Images/Site/ico-app.png">
                 <h2>My Calendar</h2>
                 <p>(See Calendar and Set Availability)</p>
            </div>
        </a>
    </div>
</div>
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCWPsHgg9LxtW336S0grd6PjYHFdi_fycI"></script>
