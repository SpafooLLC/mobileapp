...
function NSR_SaveUserResponse() {
   ...
   //$('div[id*="mpeEmpresa"]')
    ...
    var data = "{'UN':'" + UN + "','FN':'" + FN + "','LN':'" + LN + "','EM':'" + EM + "','P':'" + P + "','PH':'" + PH + "','MB':'" + MB + "','STR':'" + STR + "','City':'" + City + "','State':'" + State + "','Zip':'" + Zip + "','PID':'" + NSR_PID + "','GDR':'" + Gender + "','UR':'" + NSR_GlobalUserSelections + "','SRVC':'"+_SRVC+"','MID':'434'}";
