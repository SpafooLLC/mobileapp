...
(function (AddClientReviewController_1) {
    var AddClientReviewController = /** @class */ (function () {
        ...
        AddClientReviewController.prototype.CompleteApp = function () {
            ...
            self.discount = self.$stateParams.discount;
            ...
            //$("#PDone").modal();
            self.SharedHttp.completeAppService(self.UserID, self.clientId, self.authTxnIDField, self.appointmentIDField, self.payTxnIDField, self.amountField, self.$stateParams.comment, self.PID, self.PPID, self.discount);
        };
