...
(function (ProAppointmentDetailController_1) {
    var ProAppointmentDetailController = /** @class */ (function () {
        ...
        ProAppointmentDetailController.prototype.onError = function () {
        };
        ProAppointmentDetailController.prototype.getClientSchedular = function (AppID) {
            ...
            self.CustomerHttp.get('/GetAppointment/' + AppID).then(function (response) {
                ...
                self.SharedHttp.GetAddressInfo(self.ServiceData.appointmentIDField).then(function (e) {
                    self.ServiceData.addressField = e;
                    //  console.log(self.ServiceData.addressField);
                    self.addMarkers();
                });
                var serviceName = "";
