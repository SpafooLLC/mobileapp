...
(function (FindProviderController_1) {
    var FindProviderController = (function () {
        ...
        FindProviderController.prototype.GetWithInMile = function () {
            var self = this;
            ...
            self.CustomerHttp.get('/ListProvidersByServices/' + serviceId).then(function (response) {
                if (response.ListProvidersByServicesResult.length != 0) {
                    for (var i = 0; i < response.ListProvidersByServicesResult.length; i++) {
                        self.addMarkers(response.ListProvidersByServicesResult[i].userInfoField.vanityUrlField, response.ListProvidersByServicesResult[i].userInfoField.userIDField);
                        if (i == 0) {
                            var lat = response.ListProvidersByServicesResult[i].userInfoField.vanityUrlField.substring(0, response.ListProvidersByServicesResult[i].userInfoField.vanityUrlField.indexOf(':'));
                            var long = response.ListProvidersByServicesResult[i].userInfoField.vanityUrlField.substring(response.ListProvidersByServicesResult[i].userInfoField.vanityUrlField.indexOf(':') + 1);
