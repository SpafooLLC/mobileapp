...
(function (ServicesController_1) {
    var ServicesController = /** @class */ (function () {
        function ServicesController($q, $state, $ionicPopup, $ionicLoading, $scope, $location, CustomerHttp, $window, toaster, SharedHttp, $http) {
            this.$q = $q;
            this.$state = $state;
        ...
        ServicesController.$inject = ['$q', '$state', '$ionicPopup', '$ionicLoading', '$scope', '$location', 'CustomerHttp', '$window', 'toaster', 'SharedHttp', '$http'];
